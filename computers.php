      ...
      <!-- Begin Page Content -->
            ...
            <div class="card-header py-3">
              <div class="row">
                  <div class="col col-md-3">
                    <div class="text-left h4">จัดการอุปกรณ์</div>
                  </div>
                   <div class="col col-md-3">
                  ...
                  <div class="col col-md-6 col-sm-12 text-right">
                    ...
                    &nbsp;|&nbsp;
                    <a href="software.php" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="card-header py-3">
              <div class="row">
                  <div class="col col-md-6">
                    <div class="text-left h4">เพิ่มอุปกรณ์</div>
                  </div>
                  <div class="col col-md-6">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-sm-12">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-md-right">รหัสทรัพย์สิน</label>
                            <div class="col-sm-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col col-md-6">
                  <div class="text-left h4">แก้ไขข้อมูลอุปกรณ์</div>
                </div>
                <div class="col col-md-6">
